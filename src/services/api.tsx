...
import { MealSummaryYear } from "@/model/mealActivity";
...
export const getMealSummaryYear=async(year:number)=>{
    const res=await apiClient({
        url: "/meal_activity/meal-summary-year",
        method: "GET",
        params:{
            year:`${year}`
        },
