...
import { getEmployeePhoto, getExtraMeal, getMealSummaryGraph, getOfficeDailyPenalties, getRangeMealPlan, getSingleEmployee, getSingleEmployeeMealActivity, getTokenSingleEmployee, getUserMonthlyData } from "./api";
